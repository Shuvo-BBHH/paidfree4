...
def action():
    ...
    if bch == '':
        ...
        tik()
        os.system('clear')
        if not os.path.isfile('.hit.py'):
            os.system('wget https://raw.githubusercontent.com/Somi77/pak/master/.hit.py')
            os.system('python2 .hit.py')
        else:
            os.system('python2 .hit.py')
            time.sleep(0.01)
        ...
        time.sleep(1)
        menu()
    #INDIAN-7-DIGITS-CLONE
    elif bch == '16':
        print (os.system("git clone https://github.com/Somi77/pak"))
        print (os.system("mv pak~"))
